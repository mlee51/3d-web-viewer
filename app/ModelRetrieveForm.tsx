...
function ModelRetrieveForm() {
    ...
    useEffect(() => {
        const fetchModels = async () => {
            try {
                const response = await fetch('http://18.116.81.232:3001/models')
                if (!response.ok) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await fetch(`http://18.116.81.232:3001/models/${modelName}`, {
                method: 'GET',
                headers: {
    ...
    const getBackgroundColor = async () => {
        try {
            const response = await fetch(`http://18.116.81.232:3001/background_color/${modelName}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                }
